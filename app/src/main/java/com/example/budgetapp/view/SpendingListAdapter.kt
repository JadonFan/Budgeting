...
***REMOVED***
        view.findViewById<TextView>(R.id.spending_identifier_text).apply ***REMOVED***
            text = spendingIdentifier
***REMOVED***
        view.findViewById<TextView>(R.id.spending_amount_text).apply ***REMOVED***
            text = amount.toString()
***REMOVED***
        view.findViewById<TextView>(R.id.spending_location_text).apply ***REMOVED***
            text = location
***REMOVED***
